...
public class TblCompanyGroupRequest {
    ...
    @NotNull (message = "Please Enter Group Code")
    @NotEmpty (message = "Please Enter Group Code")
    private String groupCode;
    @NotNull (message = "Please Enter Group Name")
